    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-red-500/30">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-black/90 backdrop-blur-xl border-b border-white/5' : ''}`}>
        <div className="max-w-7xl mx-auto px-6 py-4 md:px-12 flex items-center justify-between">
          <Link href="/demos" className="flex items-center gap-3 group">
      ...
      {/* Hero Section */}
      <section data-section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      {/* Benefits Section */}
      <section id="benefits" data-section className="relative py-24 md:py-32 overflow-hidden">
      ...
      {/* Method Section */}
      <section id="method" data-section className="relative py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
      ...
      {/* Science Section */}
      <section id="science" data-section className="relative py-24 md:py-32 bg-gradient-to-b from-red-950/20 via-black to-black">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
      ...
      {/* CTA Section */}
      <section id="cta" data-section className="relative py-24 md:py-32">
